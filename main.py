...
if isExistingWeights == False:
    assert initialGroup == 0,"The initialGroup should be 0 if the \
                        isExistingWeights is False"
elif:
    assert initialGroup != 0,"The initialGroup should not be 0 if the \
                        isExistingWeights is True"
